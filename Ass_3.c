...
{
    int free_size;
    struct Free_list *next_ptr;
    struct Free_list *prev_ptr;
}Free;
...
int main()
{
    ...
    /*printf("\n\n");
    printf("%d\t %d\t %d\n",p1->tag,p1->size,p1->isFree);
    printf("%d\t %d\t %d\n",p2->tag,p2->size,p2->isFree);
    printf("%d\t %d\t %d\n",p3->tag,p3->size,p3->isFree);
    printf("%d\t %d\t %d\n",p4->tag,p4->size,p4->isFree);
    printf("%d\t %d\t %d\n",p5->tag,p5->size,p5->isFree);
    printf("%d\t %d\t %d\n",p6->tag,p6->size,p6->isFree);
    printf("%d\t %d\t %d\n",p7->tag,p7->size,p7->isFree);
    */
	return 0;
}
